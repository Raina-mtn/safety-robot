<template>
  <PageLayout class="app-container">
    ...
    <div slot="btns">
      ...
      <el-button type="primary" @click="$refs.maintenDialog.openDialog()">更多筛选</el-button>
    ...
    <WTable
      ...
      @pageChange="getList" 
    />
    <MaintenDialog ref="maintenDialog"></MaintenDialog>
  </PageLayout>
</template>
...
export default {
  ...
  computed:{
    maintenFormColums(){
      return maintenFormColums(this)
    },

    maintenColums(){
      return maintenColums(this)
    },
  },
  methods: {
