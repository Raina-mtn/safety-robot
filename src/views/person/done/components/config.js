...
//故障工单-配合处理班组
export const riskDispatchColums =(that)=> {
  return [
    {
      label: '协同处理班组',
      prop: 'handel',
...
//故障工单-班组处理-故障类型
export const riskGroupType =(that)=> {
  return [
    {
      label: '故障类型',
      prop: 'realName',
...
//故障工单-班组处理-处理进展
export const riskGroupProgress =(that)=> {
  return [
    {
      label: '进展情况',
      prop: 'realName',
...
//故障工单-班组处理-备品备件消耗
export const riskGroupConsum =(that)=> {
  return [
    {
      label: '物资编码',
      prop: 'realName',
...
//事件提报-责任部门处理-调查进展
export const progressColums =(that)=> {
  return [
    {
      label: '进展情况',
      prop: 'realName',
